...
| `primaryRoadForceEvery` | `4` (1–16) | Forces every Nth candidate primary corridor to limit gaps. |
...
| `minimumRoadSeparation` | `4` (2–32) | Minimum chunk distance between parallel secondary roads. |
