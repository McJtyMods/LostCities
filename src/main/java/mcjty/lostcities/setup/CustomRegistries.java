...
public class CustomRegistries {
    ...
    public static final Supplier<IForgeRegistry<PredefinedCityRE>> PREDEFINEDCITIES_REGISTRY = PREDEFINEDCITIES_DEFERRED_REGISTER.makeRegistry(PredefinedCityRE.class, () -> new RegistryBuilder<PredefinedCityRE>().dataPackRegistry(PredefinedCityRE.CODEC));
    ...
    public static final Supplier<IForgeRegistry<PredefinedSphereRE>> PREDEFINEDSPHERES_REGISTRY = PREDEFINEDSPHERES_DEFERRED_REGISTER.makeRegistry(PredefinedSphereRE.class, () -> new RegistryBuilder<PredefinedSphereRE>().dataPackRegistry(PredefinedSphereRE.CODEC));
    ...
    public static final Supplier<IForgeRegistry<ScatteredRE>> SCATTERED_REGISTRY = SCATTERED_DEFERRED_REGISTER.makeRegistry(ScatteredRE.class, () -> new RegistryBuilder<ScatteredRE>().dataPackRegistry(ScatteredRE.CODEC));
