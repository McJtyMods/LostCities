...
public class Config {
    ...
    public static final ForgeConfigSpec.IntValue CACHE_CLEANUP_SECONDS;
    ...
    public static final ForgeConfigSpec.BooleanValue OPTIMIZED_HEIGHTMAP;
    public static final ForgeConfigSpec.IntValue HEIGHT_SAMPLE_SIZE;
