...
public class NormalTerrainGenerator {
    ...
    // A OctavesNoiseGenerator used in generating terrain
    ...
    public void setup(IWorld world) {
        ...
        this.minLimitPerlinNoise = new OctavesNoiseGenerator(provider.rand, 16);
        this.maxLimitPerlinNoise = new OctavesNoiseGenerator(provider.rand, 16);
        this.mainPerlinNoise = new OctavesNoiseGenerator(provider.rand, 8);
        this.surfaceNoise = new PerlinNoiseGenerator(provider.rand, 4);
        OctavesNoiseGenerator noiseGen5 = new OctavesNoiseGenerator(provider.rand, 10);
        this.depthNoise = new OctavesNoiseGenerator(provider.rand, 16);
        OctavesNoiseGenerator mobSpawnerNoise = new OctavesNoiseGenerator(provider.rand, 8);
...
//        OverworldGenSettings settings = provider.getSettings();
