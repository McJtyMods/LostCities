...
public final class StructureAvoidance {
    ...
    private static boolean hasAvoidedStructure(WorldGenRegion region, ChunkAccess chunk,
                                               boolean insideFootprint, boolean terrainTransition) {
